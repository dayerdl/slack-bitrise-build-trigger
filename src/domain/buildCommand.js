...
export function buildSlackUsage() {
  return (
    [
      ...
      "• `/flutter-build release add | client:moa | version:4.2.400 | date:2026-05-04 | env:prod | status:released | notes:APP-999` — append a row to `client-releases.tsv` (needs GitHub token on Vercel).",
      "• `/flutter-build release delete | client:moa | version:4.2.400` — remove that row.",
